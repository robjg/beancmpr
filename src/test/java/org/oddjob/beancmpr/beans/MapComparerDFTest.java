 ...
 *
 */
public class MapComparerDFTest extends TestCase {
	private static final Logger logger = LoggerFactory.getLogger(MapComparerDFTest.class);
	...
	public void testCreate() throws ArooaParseException, ParseException {
		...
		String xml =  
				"<beancmpr:map-comparer xmlns:beancmpr='oddjob:beancmpr'" +
				"      keys='id, colour'" +
		...
		MapComparerType<?, ?> test = (MapComparerType<?, ?>) 
	...
	public static void main(String args[]) throws ArooaParseException, ParseException {
		...
		MapComparerDFTest test = new MapComparerDFTest();
		test.testCreate();
